...
router.get('/', (req, res) => {
    ...
    const authorizeUrl = `https://discord.com/api/oauth2/authorize?client_id=718454708423098384&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fauthorize%2Fcallback&response_type=code&scope=identify%20guilds`;
